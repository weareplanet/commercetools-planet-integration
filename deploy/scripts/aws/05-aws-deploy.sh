...
echo " "
echo "########## Planet Payment CommerceTools connector - deployment AWS infrastructure, starting now, at ${NOW}."
echo " "
...
echo " "
echo "##### Creating CF template file: ${STACKNAME}-${STACKID}_${AWSREGION}_${NOW}.yaml"
...
echo "   ## done."
echo " "
echo "   ## updating template variables with '.env' contents"
#env | grep "^CT.*" # uncomment for debugging
for var in "${!CT@}"; do
    #echo "var is ${var} with value '${!var}'" # uncomment for debugging
