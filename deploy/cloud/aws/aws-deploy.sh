...
if [[ ${EXTENSION_TYPE} = "AwsLambda" ]]; then
   ...
   echo -e "##### Automatic configuration only supports ARN-based access at this time. env file must be manually configured for HTTP-based setup, i.e. for API Gateway."
fi
