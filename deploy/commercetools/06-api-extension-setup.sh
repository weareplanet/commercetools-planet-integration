...
echo " "
echo "########## Planet Payment CommerceTools connector - setup API-Extension on CommerceTools, started at ${NOW}."
#
#####
...
#
echo " "
echo "##### Creating the new API-Extension '${CT_NEW_API_EXTENSION_NAME}'..."
